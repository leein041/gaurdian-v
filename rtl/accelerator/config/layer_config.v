...
module layer_config #(
    ...
    output reg                                                 o_pad,
    output reg                                                 o_relu,
    output reg [                                          1:0] o_kernel_side,
    output reg [                                          3:0] o_kernel_area,
    ...
    output reg [                `CLOG2_SAFE(`MAX_TILE_AREA):0] o_tile_ipt_area,
    output reg [            `CLOG2_SAFE(`MAX_PAD_TILE_SIDE):0] o_pad_tile_side,
    output reg [            `CLOG2_SAFE(`MAX_PAD_TILE_AREA):0] o_pad_tile_area,
  ...
  always @(*) begin
    case (i_lyr_idx)
      0: begin
        ...
        o_pad                = `L0_PAD;
        o_relu               = `L0_RELU;
        o_kernel_side        = `L0_KERNEL;
        o_kernel_area        = `L0_KERNEL * `L0_KERNEL;
        ...
        o_tile_ipt_area      = `L0_TILE_IPT_AREA;
        o_pad_tile_side      = `L0_PAD_TILE_SIDE;
        o_pad_tile_area      = `L0_PAD_TILE_AREA;
      ...
      1: begin
        ...
        o_pad                = `L1_PAD;
        o_relu               = `L1_RELU;
        o_kernel_side        = `L1_KERNEL;
        o_kernel_area        = `L1_KERNEL * `L1_KERNEL;
        ...
        o_tile_ipt_area      = `L1_TILE_IPT_AREA;
        o_pad_tile_side      = `L1_PAD_TILE_SIDE;
        o_pad_tile_area      = `L1_PAD_TILE_AREA;
      ...
      2: begin
        ...
        o_pad                = `L2_PAD;
        o_relu               = `L2_RELU;
        o_kernel_side        = `L2_KERNEL;
        o_kernel_area        = `L2_KERNEL * `L2_KERNEL;
        ...
        o_tile_ipt_area      = `L2_TILE_IPT_AREA;
        o_pad_tile_side      = `L2_PAD_TILE_SIDE;
        o_pad_tile_area      = `L2_PAD_TILE_AREA;
      ...
      3: begin
        ...
        o_pad                = `L3_PAD;
        o_relu               = `L3_RELU;
        o_kernel_side        = `L3_KERNEL;
        o_kernel_area        = `L3_KERNEL * `L3_KERNEL;
        ...
        o_tile_ipt_area      = `L3_TILE_IPT_AREA;
        o_pad_tile_side      = `L3_PAD_TILE_SIDE;
        o_pad_tile_area      = `L3_PAD_TILE_AREA;
      ...
      4: begin
        ...
        o_pad                = `L4_PAD;
        o_relu               = `L4_RELU;
        o_kernel_side        = `L4_KERNEL;
        o_kernel_area        = `L4_KERNEL * `L4_KERNEL;
        ...
        o_tile_ipt_area      = `L4_TILE_IPT_AREA;
        o_pad_tile_side      = `L4_PAD_TILE_SIDE;
        o_pad_tile_area      = `L4_PAD_TILE_AREA;
      ...
      5: begin
        ...
        o_pad = `L5_PAD;
        o_relu = `L5_RELU;
        o_kernel_side = `L5_KERNEL;
        o_kernel_area = `L5_KERNEL * `L5_KERNEL;
        ...
        o_tile_ipt_area = `L5_TILE_IPT_AREA;
        o_pad_tile_side = `L5_PAD_TILE_SIDE;
        o_pad_tile_area = `L5_PAD_TILE_AREA;
