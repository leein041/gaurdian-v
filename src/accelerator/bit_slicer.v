...
module bit_slicer #(
  ...
  // ====================== reg ============================
  reg                          r_opt_vld;
  reg signed [OUTPUT_BITS : 0] r_opt_dat;
  // ====================== assign =========================  
    ...
    if (~i_rstn) begin
      ...
      case ({
        ...
        2'b10, 2'b11: begin
          ...
          if (!i_ipt_din[23] && |i_ipt_din[INPUT_BITS-1:24]) begin  // 양수 최댓값
            r_opt_dat <= 16'sh7FFF;
          end else if (i_ipt_din[23] && !(&i_ipt_din[INPUT_BITS-1:24])) begin  // 음수 최솟값
            r_opt_dat <= 16'sh8000;
